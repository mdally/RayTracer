...
void CameraInterface::cb_Persp_i(Fl_Button*, void*) {
  cameraUI.changeProjection();
}
void CameraInterface::cb_Persp(Fl_Button* o, void* v) {
  ((CameraInterface*)(o->parent()->user_data()))->cb_Persp_i(o,v);
}

Fl_Double_Window* CameraInterface::make_window() {
  Fl_Double_Window* w;
  { Fl_Double_Window* o = m_cameraWindow = new Fl_Double_Window(155, 221, "Camera UI");
    w = o;
    ...
    { Fl_Button* o = new Fl_Button(10, 170, 135, 25, "Persp. / Ortho.");
      o->callback((Fl_Callback*)cb_Persp);
    }
    o->end();
    o->resizable(o);
  }
